...
This repository provides context to the manuscript "*FPGA-Enabled Machine Learning Applications in Earth Observation: A Systematic Review*" published in [ACM CSUR](https://doi.org/10.1145/3800686), available on [arXiv](https://arxiv.org/abs/2506.03938) and [HuggingFace](https://huggingface.co/papers/2506.03938).

The data from the surveyed research articles (also available as a [HuggingFace dataset](https://huggingface.co/datasets/CedricLeon/Articles_systematic_survey_RS-ML-FPGA.)), the code for the data analysis, figure and table generation, as well as the supplemental material are available here.
...
**How to cite**:
> Cedric Leonard, Dirk Stober, and Martin Schulz. 2026. FPGA-Enabled Machine Learning Applications in Earth Observation: A Systematic Review. ACM Comput. Surv. 58, 11, Article 283 (August 2026), 36 pages. <https://doi.org/10.1145/3800686>
...
The data is available as a [HuggingFace dataset](https://huggingface.co/datasets/CedricLeon/Articles_systematic_survey_RS-ML-FPGA.)
...
Before any coding you should obtain a couple of information, mainly your private Zotero API Key accessible [on Zotero website](https://www.zotero.org/settings/security#applications).
...
You will also need your collection keys (that you can find with the `all_collections()` method) and your identifier that you can obtain [on Zotero website](https://www.zotero.org/settings/security#applications).
