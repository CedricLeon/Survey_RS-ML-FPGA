...
### Collection of BOARD parameters
#           PART,   :  YEAR     : DSP (7-series use DSP48E1, US+ DSP48E2) : Type
fpga_part_info = {
        ...
        "U280"      : [2018,9024,   "Alveo"], # Q1 2019 https://www.hpcwire.com/off-the-wire/xilinx-announces-new-alveo-u280-hbm2-accelerator-card/
        "XCK26"     : [2021,1248,   "Kria"], #(Internet search but uses Zynq MPSOC (2015 ...))
        #Intel
        "5CSXC6"    : [2012,112,    "Cyclone"], #Intel DSPs
