...
\parbox[t]{2mm}{\multirow{20}{*}{\rotatebox[origin=c]{90}{Classification}}} & \multirow[c]{12}{*}{RGB} & \multirow[c]{4}{*}{NWPU-RESISC45 (45)} & \cite{yanAutomaticDeploymentConvolutional2022a} & 2022 & Improved VGG16 & VGG16 & Artix-7 & 88.08 (OA) & 14.80 & 1780 ms & 40.96 & 3.41 \\
 ...
 & & & \cite{niAlgorithmHardwareCoOptimization2023} & 2023 & VGG16 & VGG16 & Virtex-7 & 91.90 (OA) & 14.70 & 89.1 ms & 344 & 14.97 \\
              \cmidrule{3-12}
 & & \multirow[c]{2}{*}{L8 Biome (2)} & \cite{pitonakCloudSatNet1FPGABasedHardwareAccelerated2022} & 2022 & CloudSatNet-1 Q2 &  & Z7020 & 83.41 (OA) & 1.43 & 15.46 FPS &  & 2.55 \\
 & & & \cite{pitonakCloudSatNet1FPGABasedHardwareAccelerated2022} & 2022 & CloudSatNet-1 Q4 &  & Z7020 & 87.42 (OA) & 3.06 & 15.47 FPS &  & 2.55 \\ 
              \cmidrule{3-12}
 & & \multirow[c]{2}{*}{MASATI (2)} & \cite{nerisFPGABasedImplementationCNN2022a} & 2022 & AlexNetLite & AlexNet & KU040 & 89 (F1) &  &  &  &  \\
 ...
 & & UAV RGB (cust.) (4) & \cite{matos-carvalhoStaticDynamicAlgorithms2019} & 2019 & MLP &  & Spartan-3A & 95.14 (OA) &  &  &  &  \\
       \cmidrule{2-12}
 & \multirow[c]{6}{*}{SAR} & \multirow[c]{4}{*}{MSTAR (10)} & \cite{weiFPGABasedHybridTypeImplementation2019} & 2019 & Modified LeNet-5 & LeNet-5 & Kintex-7 & 97.77 (OA) & 1.66 & 2.29 ms &  &  \\
 ...
 \parbox[t]{2mm}{\multirow{12}{*}{\rotatebox[origin=c]{90}{Pixel classification}}} & \multirow[c]{9}{*}{HSI} & \multirow[c]{6}{*}{University of Pavia (9)} & \cite{heConfigurable2D3D2023a} & 2023 & 2D CNN &  & ZU15EG & 98.24 (OA) & 1.20 & 0.097 ms & 7.07 & 8.40 \\
 ...
 & & & \cite{shibiOnboardTargetDetection2021a} & 2021 & LPDBL &  & Virtex-7 & & & & &  \\
              \cmidrule{3-12}
 & & \multirow[c]{2}{*}{AVIRIS-NG (6)} & \cite{gyaneshwarRealtimeSCSUP2022} & 2022 & CAL-SC2S &  & Artix-7 & 29.69 (OA) &  & 2410 ms &  & 0.36 \\
 ...
 &  & Airport-Beach-Urban (???) & \cite{boyleHighlevelFPGADesign2023a} & 2023 & Deep Belief Network &  & ZU7EV &  &  & 5.4 ms &  &  \\
       \cmidrule{2-12}
 & \multirow[c]{2}{*}{RGB} & UAV RGB (cust.) (7) & \cite{fraczekEmbeddedVisionSystem2018} & 2018 & Decision Tree &  & Z7020 & 92.1 (OA) &  & 300 ms &  & 3.50 \\
              \cmidrule{3-12}
 ...
 \parbox[t]{2mm}{\multirow{6}{*}{\rotatebox[origin=c]{90}{Segmentation}}} & \multirow[c]{6}{*}{RGB} & \multirow[c]{4}{*}{Potsdam (6)} & \cite{sabogalMethodologyEvaluatingAnalyzing2021a} & 2021 & ENet &  & ZU3EG & 63.3 (mIoU) & 0.36 & 25.2 FPS &  & 3.36 \\
 ...
 \parbox[t]{2mm}{\multirow{19}{*}{\rotatebox[origin=c]{90}{Object detection}}} & \multirow[c]{15}{*}{RGB} & \multirow[c]{4}{*}{DOTAv1.0 (15)} & \cite{yanAutomaticDeploymentConvolutional2022a} & 2022 & Improved YOLOv2 & Darknet19 & Artix-7 & 67.30 (mAP) & 49.40 & 17120 ms & 379.55 & 3.41 \\
 ...
 & & & \cite{yangLightweightDetectionMethod2023} & 2023 & Ghost-YOLOS & GhostNet & Z7020 & 62.58 (mAP) & 12.60 & 3 FPS & 29.53 & 2.98 \\
              \cmidrule{3-12}
 & & \multirow[c]{2}{*}{PennSyn2Real (21)} & \cite{suhAlgorithmHardwareCoOptimizationEnergyEfficient2021} & 2021 & SSD 0.25x & VGG16 & ZU3EG & 76.2 (mAP) &  & 34.18 FPS & 138 & 2.40 \\
 ...
 & & & \cite{suhAlgorithmHardwareCoOptimizationEnergyEfficient2021} & 2021 & SSD 1.0x & VGG16 & ZU3EG & 88.4 (mAP) &  & 2.56 FPS & 158 & 2.00 \\
              \cmidrule{3-12}
 & & \multirow[c]{2}{*}{DIOR} & \cite{liEdgeRealtimeObject2023a} & 2023 & RFA-YOLO & MobileNeXt & ZU7EV & 64.85 (mAP) & 24.75 & 27.97 FPS &  & 15.82 \\
...
% \pagebreak
 ...
 & RGB + MMW & UAV RGB+MMW (cust.) (4) & \cite{wangFastDetectionObstacle2024} & 2024 & Lightweight CNN & ResNet-18 & Z7020 & 70.1 (mAP) &  & 60.0 FPS &  & 3.30 \\
       \cmidrule{2-12}
 & \multirow[c]{3}{*}{SAR} & \multirow[c]{3}{*}{SSDD (1)} & \cite{yangAlgorithmHardwareCodesign2022} & 2022 & CNN1@1.6 & MobileNetv1 & Virtex-7 & 94 (AP) & 0.51 & 385 FPS & 221 & 4.80 \\
